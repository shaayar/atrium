...
const ProcessStep: React.FC<{
  ...
  return (
    <div className={`flex flex-col ${align === 'right' ? 'md:flex-row' : 'md:flex-row-reverse'} items-center justify-center gap-12 md:gap-24 relative z-10`}>
      ...
      >
        <div className="aspect-square w-80 md:w-96 lg:w-[28rem] border border-white/10 bg-surface/50 backdrop-blur-sm flex items-center justify-center relative group overflow-hidden rounded-2xl shadow-2xl">
            {image ? (
                <>
